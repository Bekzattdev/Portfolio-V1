...
import { TypingText, TypingTitle } from "../../typing_text/Typing";
// import { GithubIcon } from "@/appPages/site/components/pages/svgs/github.svg";
import Beko from "@/assets/Bekzattdev.png";
              ...
              <div className={scss.left}>
                ...
                <div className={`${scss.text__z__index} ${scss.my__icons}`}>
                  ...
                  {/* <motion.a
                    ...
                    variants={animationIcons}
                    className={scss.icon}
                    href="https://github.com/Bekzattdev"
                    target="_blank"
                    aria-label="GitHub"
                  >
                    <GithubIcon />
